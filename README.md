...
| ------------- |:-------------:| -----:|
| ballerina-0.963.1-SNAPSHOT     | 0.1 | 5.6.6 and 5.6.7 |
...
| ------------- |:----------------:|
| serverURL    |Your SonarQube server URL ex - (https://wso2.org/sonar)|
| username  |username of your SonarQube server account   |
| password  |password of your SonarQube server account   |
