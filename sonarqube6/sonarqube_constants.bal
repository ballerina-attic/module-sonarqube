...
documentation{Metric key to get number of  code smells
}
@final public string CODE_SMELLS = "code_smells";

documentation{Metric key to get complexity
}
@final public string COMPLEXITY = "complexity";

documentation{Metric key to get severity
}
@final public string SEVERITY = "severity";

documentation{Metric key to get line coverage
}
@final public string LINE_COVERAGE = "line_coverage";

documentation{Metric key to get branch coverage
}
@final public string BRANCH_COVERAGE = "branch_coverage";

documentation{Metric key to get sqale rating
}
@final public string SQALE_RATING = "sqale_rating";

documentation{Metric key to get technical debt
}
@final public string TECHNICAL_DEBT = "sqale_index";

documentation{Metric key to get technical debt ratio
}
@final public string TECHNICAL_DEBT_RATIO = "sqale_debt_ratio";

documentation{Metric key to get number of duplicated blocks
}
@final public string DUPLICATED_BLOCKS_COUNT = "duplicated_blocks";

documentation{Metric key to get number of duplicated files
}
@final public string DUPLICATED_FILES_COUNT = "duplicated_files";

documentation{Metric key to get number of duplicated lines
}
...
documentation{Metric key to get reliability rating
}
@final public string RELIABILITY_RATING = "reliability_rating";

documentation{Metric key to get number of uncovered lines
}
@final public string UNCOVERED_LINES = "uncovered_lines";

documentation{Metric key to get number of blocker issues
}
@final public string BLOCKER_ISSUES_COUNT = "blocker_violations";

documentation{Metric key to get number of critical issues
}
@final public string CRITICAL_ISSUES_COUNT = "critical_violations";

documentation{Metric key to get number of major issues
}
@final public string MAJOR_ISSUES_COUNT = "major_violations";

documentation{Metric key to get number of minor issues
}
@final public string MINOR_ISSUES_COUNT = "minor_violations";

documentation{Metric key to get number of open issues
}
@final public string OPEN_ISSUES_COUNT = "open_issues";

documentation{Metric key to get number of confirmed issues
}
@final public string CONFIRMED_ISSUES_COUNT = "confirmed_issues";

documentation{Metric key to get number of repoened issues
}
@final public string REOPENED_ISSUES_COUNT = "reopened_issues";

documentation{Metric key to get number of vulnerabilities
}
@final public string VULNERABILITIES = "vulnerabilities";

documentation{Metric key to get number of bugs
}
@final public string BUGS_COUNT = "bugs";

documentation{Metric key to get lines of code
}
