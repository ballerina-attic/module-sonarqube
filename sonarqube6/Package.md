...
The SonarQube connector allows you to work with SonarQube projects and get important code-quality measurements like 
line coverage, branch coverage, code smells, etc. It handles basic authentication.
